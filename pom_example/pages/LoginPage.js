...
export default class LoginPage {
    ...
    async login(username, password){
        await this.actions.fill(this.usernameSelector, username)  //this is the export default class LoginPage... //can also be replaced with the pattern below and export default deleted
